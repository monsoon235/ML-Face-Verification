...
class Pooling:
    ...
    axis_coe_h: torch.Tensor
    axis_coe_w: torch.Tensor
    ...
    def __init__(self, input_shape, pool_size, activate_func: str = None) -> None:
        ...
        self.axis_coe_h = torch.arange(0, self.height, self.pool_size)
        self.axis_coe_w = torch.arange(0, self.width, self.pool_size)
